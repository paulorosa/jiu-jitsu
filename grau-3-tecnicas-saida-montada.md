...
* **Erro Comum:** Tentar fazer a ponte sem travar o pé do oponente (ele vai abrir a base e você gastará energia à toa).
* **Vídeo Sugerido:** 

## 2. Reposição (Cotovelo/Joelho)
...
* **Erro Comum:** Virar de costas ou expor o pescoço ao virar de lado. Mantenha o queixo colado e os braços fechados.
* **Vídeo Sugerido:** [Saída de Cotovelo: A posição mais eficaz](https://www.youtube.com/watch?v=9nnhssipEuQ)

## 3. Pé com Pé (Alavanca)
...
* **Erro Comum:** Tentar fazer isso quando o oponente está com os pés vivos (pontas dos pés no chão) e joelhos fechados altos. Funciona melhor quando as pernas dele estão esticadas ou cruzadas baixas.
* **Vídeo Sugerido:** [Saída da Montada + Finalização de Chave de Pé (Conceito Pé com Pé)](https://www.youtube.com/watch?v=PSCUKfy1X5Q)

---

## Reserva 1. Saída da Montada para Chave de Pé (Botinha)
