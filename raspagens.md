...
# Guia de Estudos: Raspagens (Exame Faixa Marrom)

Este bloco cobre as 14 raspagens obrigatórias (Guarda Fechada, Aberta e Meia) e 2 variações de reserva. O foco é o desequilíbrio (*Kuzushi*) antes da execução da força.

---

## 44. Tesoura (Scissor Sweep)
...
* **Como fazer:** Domine a manga e a calça (ou perna) do mesmo lado. Gire o corpo (pêndulo) jogando suas pernas para o lado oposto da pegada. Use o momento do giro para capotar o oponente sobre sua cabeça.
...
## 47. Raspagem de Gancho (Butterfly Sweep)
* **Como fazer:** Sentado, com ganchos por dentro das coxas. Domine um braço (esgrima) e a faixa ou pescoço. Caia para o lado do braço dominado, elevando o gancho oposto para chutar o oponente.
...
## 48. Raspagem de Gancho Cruzada (Hook Sweep)
* **Como fazer:** Variação da borboleta onde você segura a manga cruzada e a faixa (ou calça) do lado oposto. Chute o gancho invertendo a base.
...
## 51. Raspagem de Meia-Guarda (Old School / Lucas Leite)
...
## 52. Raspagem de Meia-Guarda Profunda (Waiter Sweep)
...
## 53. Raspagem da Guarda Aranha (Tesourinha)
...
## 54. Raspagem da Guarda De La Riva (Balão)
...
## 55. Raspagem da Guarda De La Riva (Sentando / Berimbolo Setup)
* **Como fazer:** Sente-se abraçando a perna do oponente (single leg de guarda). Gire para as costas (berimbolo) ou empurre-o para trás (sit-up sweep) derrubando.
...
## 56. Raspagem de X-Guard (Levantada Técnica)
...
## 59. Raspagem de Guarda Laço (Lasso Sweep)
