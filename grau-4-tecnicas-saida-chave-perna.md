...
1.  **Alivie a Pressão:** Com o pé vivo, empurre o pé mais para dentro ("calce a bota").
2.  **Base:** Identifique para qual lado ele está fazendo força. Você vai precisar levantar.
3.  **Recolha a Perna:** Não tente levantar com a perna esticada. Traga o seu calcanhar para perto do seu glúteo/quadril. Isso te dá base.
...
1.  **Controle a Distância:** Se não der para subir, comece a contornar o corpo dele. Segure a lapela ou manga para ter segurança.
2.  **Limpe o Quadril:** Empurre o pé dele que está no seu quadril (o pé que ele usa para manter a distância).
3.  **O Pulo:** Apoie o pé no chão e jogue o seu quadril *por cima* da perna dele, como se estivesse dando um "pulinho" para o outro lado do corpo dele.
4.  **Trava de Segurança (Crucial):** Assim que passar o quadril, pise imediatamente na perna ou atrás do joelho dele.
    * *Por que?* Para impedir que ele gire de barriga para baixo (o que tornaria a chave muito mais forte) ou te acompanhe.
5.  **Estourada:** Agora que você anulou o giro dele, chute a perna para trás ou empurre a mão dele para estourar a pegada.
6.  **Domínio:** Você cairá numa posição muito favorável, muitas vezes já caindo montado ou nas costas se ele tentar virar.
